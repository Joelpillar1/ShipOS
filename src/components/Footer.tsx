        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 text-left">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm font-normal text-[#b0aea5]">
              ...
              <li>
                <Link
                  to="/instagram-post-scheduler"
                  className="flex items-center tracking-wide hover:text-[#faf9f5] transition-colors"
                >
                  <Instagram className="w-3.5 h-3.5 mr-2 text-[#E1306C]" /> Instagram
                </Link>
              </li>
              <li>
                <Link
                  to="/threads-post-scheduler"
                  className="flex items-center tracking-wide hover:text-[#faf9f5] transition-colors"
                >
                  <svg className="w-3.5 h-3.5 mr-2 fill-current" viewBox="0 0 16 16" aria-hidden>
              ...
              <li>
                <Link
                  ...
                  className="flex items-center tracking-wide hover:text-[#faf9f5] transition-colors"
                >
                  <Twitter className="w-3.5 h-3.5 mr-2 text-foreground" /> X (Twitter)
                </Link>
              </li>
              <li>
                <Link
                  to="/bluesky-post-scheduler"
                  className="flex items-center tracking-wide hover:text-[#faf9f5] transition-colors"
                >
                  <svg className="w-3.5 h-3.5 mr-2 fill-[#0285FF]" viewBox="0 0 320 286" aria-hidden>
              ...
              <li>
                <Link
                  to="/tiktok-post-scheduler"
                  className="flex items-center tracking-wide hover:text-[#faf9f5] transition-colors"
                >
                  <svg className="w-3.5 h-3.5 mr-2 fill-current" viewBox="0 0 24 24" aria-hidden>
              ...
              <li>
                <Link
                  to="/pinterest-pin-scheduler"
                  className="flex items-center tracking-wide hover:text-[#faf9f5] transition-colors"
                >
                  <svg className="w-3.5 h-3.5 mr-2 fill-[#BD081C]" viewBox="0 0 24 24" aria-hidden>
              ...
              <li>
                <Link
                  to="/facebook-post-scheduler"
                  className="flex items-center tracking-wide hover:text-[#faf9f5] transition-colors"
                >
                  <svg className="w-3.5 h-3.5 mr-2 fill-[#1877F2]" viewBox="0 0 24 24" aria-hidden>
              ...
              <li>
                <Link
                  to="/youtube-video-scheduler"
                  className="flex items-center tracking-wide hover:text-[#faf9f5] transition-colors"
                >
                  <svg className="w-3.5 h-3.5 mr-2 fill-[#FF0000]" viewBox="0 0 24 24" aria-hidden>
