...
const Discount = () => {
 ...
 <h1 className="text-5xl font-bold text-[#1A1A1A] mb-4 tracking-tight">Secret Spinner!</h1>
 ...
 >
 <span className="text-white font-bold text-xl" style={{ transform: 'rotate(-90deg) translateX(-15px) translateY(10px)' }}>
