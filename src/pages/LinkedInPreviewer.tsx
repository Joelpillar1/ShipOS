    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col pt-20">
      ...
      <main className="flex-1 w-full py-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#d75a34]/10 border border-[#d75a34]/20 text-[#d75a34] text-xs font-bold normal-case tracking-wider rounded-none">
