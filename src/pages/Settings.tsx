                  ...
                  <div className="rounded-none border border-border overflow-hidden">
                    ...
                    <div className="px-6 pt-5 pb-4 flex items-start justify-between gap-4 border-b border-border/60">
                      <div>
                        <div className="flex items-center gap-1.5 text-muted-foreground mb-2">
                          ...
                          <span className="text-[9px] font-black uppercase tracking-[0.2em]">Current Plan</span>
                        </div>
                    ...
                    {!isFree && renewalDate && (
                      <div className="px-6 py-4 grid grid-cols-2 gap-6 bg-muted/20 border-b border-border/60">
                        <div className="flex items-start gap-2.5">
                          ...
                          <div>
                            <p className="text-[9px] font-black uppercase tracking-[0.15em] text-muted-foreground mb-1">
                    ...
                    <div className="px-6 py-4 flex flex-wrap gap-2.5 bg-card">
                      <Button
                        ...
                        className="h-9 rounded-none bg-foreground text-background hover:bg-foreground/90 text-[10px] font-bold uppercase tracking-widest px-5 shadow-none"
                      >
                      ...
                      {!isFree && !isCancelled && (
                        <Button
                          ...
                          disabled={billingBusy}
                          className="h-9 rounded-none border-destructive/30 text-destructive hover:bg-destructive/5 hover:border-destructive/50 text-[10px] font-bold uppercase tracking-widest px-5 shadow-none"
                        >
                          Cancel Subscription
                        </Button>
                      )}
                      ...
                      {isCancelled && (
                        <Button
                          ...
                          disabled={billingBusy}
                          className="h-9 rounded-none border-primary/40 text-primary hover:bg-primary/5 text-[10px] font-bold uppercase tracking-widest px-5 shadow-none"
                        >
                          Resume Subscription
                        </Button>
                      )}
                      ...
                      {isPastDue && (
                        <Button
                          onClick={handleManageBilling}
                          disabled={billingBusy}
                          className="h-9 rounded-none bg-amber-500 hover:bg-amber-600 text-white text-[10px] font-bold uppercase tracking-widest px-5 shadow-none"
                        >
                          Update Payment
                        </Button>
                      )}
                ...
                >
                  {plan.badge && (
                    <div className="absolute top-0 right-0">
                      <div className={cn(
                        "text-[10px] font-bold uppercase tracking-widest py-1 px-4 rounded-none text-white",
                  ...
                  <CardContent className="p-6 flex-1 flex flex-col justify-between pt-8">
                    <div className="space-y-6">
                      <div>
                        <div className="flex items-center justify-between gap-2 mb-1.5">
                          <h3 className="text-2xl font-black text-foreground tracking-tight leading-none">{plan.name}</h3>
                          {isActivePlan && (
                          ...
                          {isPendingPlan && (
                            <Badge className="bg-amber-500 text-white border-none rounded-none text-[8px] font-bold uppercase tracking-widest px-2 py-0.5">
                              Pending
                            </Badge>
                          )}
                        </div>
                    ...
                    <Button
                      ...
                      className={cn(
                        "w-full h-11 rounded-none text-[10px] font-bold uppercase tracking-widest shadow-none transition-all duration-300 mt-8",
                        isActivePlan
                ...
                <div>
                  {previewLoading ? (
                    <div className="flex flex-col items-center gap-3 py-6 justify-center">
                      ...
                      <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Calculating prorated charge…</span>
                    </div>
                  ) : changePlanPreview ? (() => {
                          ...
                          {changePlanPreview.isDowngrade ? (
                            <>
                              <div className="flex justify-between">
                                <span className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">Charge Today</span>
                            ...
                            <>
                              <div className="flex justify-between">
                                <span className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">Charged Today (Prorated)</span>
                              ...
                              <div className="flex justify-between border-t border-border/55 pt-2">
                                <span className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">Next Renewal Date</span>
                                <span className="text-xs font-bold">{formattedRenewalDate}</span>
                              </div>
                              <div className="flex justify-between">
                                <span className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">Next Renewal Amount</span>
