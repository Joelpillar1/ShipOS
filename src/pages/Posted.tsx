              ...
              <Card key={post.id} className="border border-border bg-card shadow-none rounded-none overflow-hidden hover:border-foreground/40 transition-colors flex flex-col p-4 gap-3">
                ...
                <div className="flex items-center justify-between gap-1 text-[10px] font-mono text-muted-foreground pb-2 border-b border-border/50 shrink-0 flex-nowrap w-full">
                  <div className="flex items-center gap-1 shrink-0 min-w-0">
                    ...
                    <span className="font-black uppercase tracking-wider text-foreground truncate">Published</span>
                          ...
                          <PopoverContent className="w-64 p-4 rounded-none border-2 border-foreground shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] bg-card overflow-hidden text-left z-50">
                            <div className="space-y-3">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <span className={cn(
                                  "text-[9px] font-black uppercase tracking-widest px-1.5 py-0.5 border rounded-none",
                                  isSuccess 
                              ...
                              {isSuccess ? (
                                <div className="space-y-2">
                                  ...
                                  {liveUrl ? (
                                    <a
                                      ...
                                      className="inline-flex w-full h-8 items-center justify-center gap-1.5 bg-primary text-primary-foreground text-[9px] font-black uppercase tracking-widest rounded-none shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] border border-foreground hover:bg-primary/95 transition-all hover:-translate-y-0.5 hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] active:translate-y-0 active:shadow-none"
                                    >
                                ...
                                <div className="space-y-2">
                                  ...
                                  <p className="text-[8px] text-muted-foreground font-medium uppercase tracking-wider italic">
                              ...
                              {accounts.slice(4).map((acc, idx) => {
                                ...
                                return (
                                  <div key={idx} className="flex items-center justify-between text-xs border border-border bg-muted/20 p-2 rounded-none">
                                    ...
                                    <span className={cn(
                                      "text-[7px] font-black uppercase tracking-widest px-1 py-0.5 border leading-none",
