...
const ForgotPassword = () => {
 ...
 <Button
 variant="outline"
 className="w-full h-10 rounded-none border-border text-[10px] font-bold tracking-widest shadow-none mt-2"
 ...
 className="w-full bg-primary hover:bg-primary/90 text-primary-foreground h-10 rounded-none text-[10px] font-bold tracking-widest shadow-none flex items-center justify-center gap-2"
 >
 {isLoading ? (
 'Sending...'
 ) : (
 ...
 <p className="text-center text-[10px] font-bold tracking-widest text-muted-foreground pt-1">
 Remember your password?{' '}
 <Link to="/login" className="text-primary hover:underline font-bold">
 Sign in
 </Link>
