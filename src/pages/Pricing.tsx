        ...
        <div className="min-h-screen bg-background">
            ...
            <div className="border-b border-border/70 bg-background">
                <div className="container mx-auto px-4 py-14 text-center relative overflow-hidden">
                    ...
                    <p className="text-sm text-muted-foreground font-bold uppercase tracking-[0.2em] max-w-2xl mx-auto">
                    ...
                    <div className="flex items-center justify-center gap-6 mt-10">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <Badge className="bg-primary text-primary-foreground text-[10px] font-black uppercase tracking-widest px-2 py-0.5 rounded-none shadow-sm">
                                Save 20%
                            </Badge>
                        </div>
                    </div>
                            ...
                            >
                                ...
                                <CardHeader className="p-8 pb-4">
                                    <div className="flex items-center justify-between mb-4">
                                        <CardTitle className="text-base font-extrabold tracking-widest uppercase text-muted-foreground">
                                            {plan.name}
                                        </CardTitle>
                                    </div>
