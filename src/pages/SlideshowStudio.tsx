...
const SlideshowStudio = () => {
 ...
 <h2 className="text-2xl font-bold tracking-tight text-foreground mb-2">Slideshow Studio is on Creator & Pro</h2>
 ...
 <span className="text-[10px] font-bold text-muted-foreground px-2 tabular-nums">
...
<Palette className="w-3.5 h-3.5" /> Active Block Settings
 ...
 {(["sentence","","lowercase"] as const).map((c) => (
 <button
 key={c}
 type="button"
...
"flex-1 h-10 text-[11px] transition-colors font-semibold rounded-none",
 ...
 title={c ==="sentence" ?"Sentence case" : c ==="" ?"" :"Lowercase"}
 >
 {c ==="sentence" ?"Aa" : c ==="" ?"AA" :"aa"}
 </button>
 ))}
 </div>
 </div>
...
"w-10 h-5 rounded-none p-0.5 transition-colors",
 ...
 <AlertDialogHeader>
 <AlertDialogTitle className="text-xl font-bold tracking-wider text-foreground">
 ...
 <AlertDialogCancel className="h-11 rounded-none border-2 border-black bg-background hover:bg-muted font-bold text-xs tracking-widest text-foreground shadow-none">
 Cancel
 </AlertDialogCancel>
 <AlertDialogAction
 onClick={() => {
 ...
 className="h-11 rounded-none border-2 border-black bg-destructive hover:bg-destructive/90 text-destructive-foreground font-bold text-xs tracking-widest shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5 transition-all"
 >
 Reset Workspace
 </AlertDialogAction>
 </AlertDialogFooter>
