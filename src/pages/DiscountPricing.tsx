        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <div className="mt-10 flex justify-center items-center gap-4">
            ...
            <span className={cn("text-sm font-semibold transition-colors flex items-center gap-2", isAnnual ? "text-foreground" : "text-muted-foreground")}>
              Annual billing <span className="bg-primary/10 text-primary text-[10px] uppercase font-bold px-2 py-0.5 rounded-none">Save 20%</span>
            </span>
          </div>
        </div>
                ...
                <CardContent className="p-8">
                  ...
                  <div className="mb-8">
                    ...
                    <div className="flex items-baseline gap-1">
                      <span className="text-5xl font-extrabold tracking-tight">${discountedCost}</span>
