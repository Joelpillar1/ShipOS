                      ...
                      <div className="flex-1 space-y-4 text-left">
                        <div className="flex flex-col md:flex-row gap-6 items-start">
                          ...
                          <div className="space-y-2 flex flex-col shrink-0 w-full md:w-48 text-left">
                            <Label className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">Workspace Icon</Label>
                            <div className="flex items-center gap-3 mt-1">
                              ...
                              />
                              <span className="text-[9px] font-bold text-muted-foreground uppercase">Preview</span>
                            </div>
                            {isMain ? (
            ...
            {(currentUserRole === 'owner' || currentUserRole === 'admin') && (
              isAdding ? (
                <form onSubmit={handleCreate} className="p-5 border border-dashed border-border space-y-4 animate-in slide-in-from-top-2 duration-300">
                  <h4 className="font-black text-[10px] uppercase tracking-widest text-foreground text-left">Create New Workspace</h4>
                  ...
                  <div className="flex flex-col md:flex-row gap-6 items-start">
                    ...
                    <div className="flex-1 space-y-4 w-full text-left">
                      <div className="space-y-1.5">
                        <Label htmlFor="new-ws-name" className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">Workspace Name</Label>
                        <Input 
                          id="new-ws-name"
