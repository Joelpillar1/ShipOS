...
"2/3: By integrating smart scheduling, content recycling, and deep growth analytics, creators save an average of 10+ hours per week.",
 ...
 <div className="relative z-10 w-full overflow-hidden">
    ...
    {/* Constrained content */}
    <section className="hero-header-padding pb-20 px-4 md:px-8 lg:px-12 max-w-5xl mx-auto text-center relative z-10">
  ...
  <section className="relative z-20 pb-8 px-4 md:px-8 max-w-5xl mx-auto">
  <FadeIn delay={0.2}>
   <div 
 ...
 <section className="relative z-20 pb-16 max-w-5xl mx-auto text-center px-4">
    <FadeIn delay={0.3}>
      <h3 className="text-gray-400 dark:text-neutral-500 font-bold uppercase tracking-wider text-xs sm:text-sm mb-6 select-none">
        Featured on:
      </h3>
      <div className="flex flex-wrap items-center justify-center gap-6 md:gap-10 opacity-75 dark:opacity-90">
        <a href="https://builders.to/projects/shipos?utm_source=badge" target="_blank" rel="noopener noreferrer" className="hover:scale-105 transition-transform duration-200">
          <img src="https://builders.to/badges/featured-on-builders.svg" alt="ShipOS - Featured on Builders.to" width="171" height="54" className="h-10 sm:h-12 w-auto dark:brightness-110" />
        </a>
        <a href="https://nicklaunches.com/" target="_blank" rel="noopener" className="hover:scale-105 transition-transform duration-200">
          <img src="https://nicklaunches.com/badges/featured.png" alt="Featured on Nick Launches" width="244" height="56" className="h-10 sm:h-12 w-auto dark:brightness-110" />
        </a>
        <a href="https://prolaunch.net" target="_blank" title="Pro Launch Featured Badge" className="hover:scale-105 transition-transform duration-200">
          <img src="https://prolaunch.net/images/badges/featured-light.svg" alt="Pro Launch Featured Badge" className="h-10 sm:h-12 w-auto dark:invert dark:brightness-200" />
        </a>
        <a href="https://shipboost.io/tools/shipos" data-shipboost-badge="free-launch" target="_blank" rel="noopener" className="hover:scale-105 transition-transform duration-200">
          <img src="https://shipboost.io/badge/cmqsg5ytn000eod0snbyv3l70?theme=light" alt="Featured on ShipBoost" width="244" height="56" className="h-10 sm:h-12 w-auto dark:brightness-110" />
        </a>
      </div>
    </FadeIn>
 </section>
