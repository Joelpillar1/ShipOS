...
const Automation = () => {
 ...
 <span className="text-[10px] font-bold tracking-widest text-muted-foreground">Systems Operational</span>
 </div>
 </div>
 </div>
 ...
 <p className="text-[10px] font-bold text-muted-foreground tracking-widest">{rule.triggers} triggers / mo</p>
 <div className="flex items-center gap-2">
 <span className="text-[10px] font-bold text-primary tracking-widest">{rule.successRate}% success</span>
 </div>
 </div>
 </div>
 </div>
 ...
 className={cn(
"text-[10px] font-bold tracking-widest px-3 py-1 rounded-none shadow-none",
 ...
 <CardTitle className="text-[10px] font-bold tracking-widest text-muted-foreground">{stat.label}</CardTitle>
 </CardHeader>
