...
"July","August","September","October","November","December"
 ...
 <div className="text-[10px] text-muted-foreground mt-2 font-medium">{post.time}</div>
 </div>
 </div>
 );
 };
 ...
 <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-4 h-4 bg-[#ff0050] rounded-full flex items-center justify-center border border-white text-white font-bold text-[9px]">
 +
 </div>
 </div>
 ...
 <div className="font-bold text-[9px] text-muted-foreground tracking-widest">Description</div>
 ...
 <span className="text-xs font-bold text-muted-foreground tracking-widest">Pin Media</span>
 </div>
 )}
 ...
 <div className="flex-1 min-w-0">
 <div className="text-xs font-bold tracking-widest leading-none truncate">{post.handle}</div>
 ...
 <span className="text-[9px] font-bold text-muted-foreground tracking-[0.4em]">Operations / Strategy</span>
 </div>
 <h1 className="text-2xl font-bold tracking-tighter text-foreground">Calendar</h1>
 </div>
 ...
 className={cn(
"h-8 px-3 flex items-center gap-1.5 text-[9px] font-bold tracking-[0.2em] transition-all rounded-none",
...
"h-8 px-3 flex items-center gap-1.5 text-[9px] font-bold tracking-[0.2em] transition-all rounded-none",
 ...
 <Button variant="ghost" className="px-4 text-[9px] font-bold tracking-[0.3em] h-8 rounded-none hover:bg-muted flex items-center gap-1.5">
 {getHeaderLabel()}
...
"text-[9px] font-bold tracking-widest px-4 py-3 rounded-none focus:bg-foreground focus:text-background transition-colors cursor-pointer",
 ...
 <span className="px-4 text-[9px] font-bold tracking-[0.3em] h-8 flex items-center">
 {getHeaderLabel()}
 </span>
 )}
 ...
 className="h-8 rounded-none bg-foreground text-background hover:bg-foreground/90 font-bold tracking-[0.2em] text-[9px] px-5 shadow-[2px_2px_0px_0px_rgba(0,0,0,0.1)] transition-all active:translate-x-[1px] active:translate-y-[1px] active:shadow-none"
 >
 ...
 <span className="text-[10px] font-bold tracking-[0.4em] text-muted-foreground">{day}</span>
 </div>
 ))}
 </div>
...
"text-[10px] font-bold tracking-widest transition-all",
 ...
 <span className="text-[8px] font-bold text-muted-foreground">{post.handle.charAt(1).toUpperCase()}</span>
 )}
 ...
 <span className="text-[10px] font-bold tracking-[0.4em] text-muted-foreground">{format(date,"EEE")}</span>
 <div className={cn(
...
"border-r border-border last:border-r-0 min-h-[480px] flex flex-col relative group",
 ...
 <span className="text-[8px] font-bold text-muted-foreground/40 tracking-widest">No posts</span>
 </div>
 )}
 {dayPosts.map((post) => (
 <div 
 ...
 <div className="text-[9px] font-bold tracking-tight text-foreground truncate">{post.handle}</div>
 ...
 <DialogTitle className="text-3xl font-bold tracking-tighter">Scheduled Queue</DialogTitle>
 </DialogHeader>
 ...
 <div>
 <div className="text-[10px] font-bold tracking-widest text-foreground">{post.handle}</div>
 ...
 className="h-8 rounded-none text-[9px] font-bold tracking-widest hover:bg-foreground hover:text-background transition-all"
 >
 Edit Post
 </Button>
 <Button
 ...
 <Badge className="bg-muted text-muted-foreground border-border text-[8px] font-bold tracking-widest py-0.5 px-1.5 rounded-none shadow-none">
 Read-Only
 </Badge>
 )}
 </div>
 ...
 <span className="text-[8px] font-bold tracking-widest text-muted-foreground group-hover/item:text-foreground transition-colors flex items-center gap-2">
 Action Required
 ...
 <AlertDialogCancel
 disabled={isDeleting}
 className="rounded-none border-border font-bold tracking-widest text-[10px] h-10 px-4 shadow-none"
 >
 Cancel
 </AlertDialogCancel>
 {currentUserRole !== 'viewer' && (
