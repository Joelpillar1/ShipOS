...
const Login = () => {
 ...
 <p className="text-sm font-bold text-muted-foreground tracking-[0.2em] mt-2">Sign in to your account</p>
 </div>
 ...
 <Link to="/forgot-password" className="text-[10px] font-bold tracking-widest text-primary hover:underline">
 Forgot password?
 </Link>
 </div>
 <div className="relative">
