        ...
        <div className="fixed inset-0 bg-background/80 backdrop-blur-md z-[100] flex flex-col items-center justify-center p-6 transition-all duration-300 animate-in fade-in">
          <div className="max-w-[450px] w-full border-2 border-dashed border-primary bg-card/50 p-12 flex flex-col items-center justify-center gap-6 shadow-2xl relative">
            ...
            <div className="text-center space-y-2">
              <h3 className="text-lg font-black uppercase tracking-widest text-foreground">Drop Media Anywhere</h3>
              ...
              {connectedAccounts.length === 0 ? (
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 border border-dashed border-destructive/60 bg-destructive/5 text-destructive-foreground">
                  <div className="space-y-1 text-left">
                    <p className="text-xs font-black uppercase tracking-widest text-destructive">No Connected Accounts</p>
                  ...
                  <Button
                    ...
                    className="rounded-none bg-primary text-primary-foreground hover:bg-primary/90 font-bold uppercase tracking-widest text-[10px] h-9 px-4 shadow-[2px_2px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-[2px] hover:translate-y-[2px] border border-black shrink-0 transition-all"
                  >
                    Connect Accounts
                  </Button>
                </div>
                ...
                {hasYouTubeSelected && postType === 'image' && (
                  <div className="bg-destructive/10 border-b border-destructive/20 p-3 px-6 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-left">
                    <div className="flex items-start gap-2.5">
                      ...
                      <div>
                        <h4 className="text-[10px] font-black uppercase tracking-widest text-red-500">YouTube Warning</h4>
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      <Button
                        ...
                        className="h-8 px-3 text-[10px] font-bold uppercase tracking-wider text-muted-foreground hover:text-foreground rounded-none border border-border/40 hover:bg-muted/50"
                      >
                        Deselect YouTube
                      </Button>
                      <Button
                        ...
                        className="h-8 px-3 text-[10px] font-black uppercase tracking-wider bg-red-600 hover:bg-red-700 text-white rounded-none border border-transparent shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-x-[1px] active:translate-y-[1px] active:shadow-[0px_0px_0px_0px_rgba(0,0,0,1)]"
                      >
                        Switch to Video
                      </Button>
                    </div>
                    ...
                    {currentMediaPreviews.length > 0 ? (
                      ...
                      >
                        ...
                        <div className="text-center">
                          ...
                          <p className="text-[10px] text-muted-foreground mt-1 uppercase">Drag & drop here or click to browse</p>
                        </div>
                      </div>
                    )}
                  </div>
                              ...
                              <div className="flex items-center gap-3">
                                {isOverLimit && (
                                  <Button
                                    ...
                                    className="h-5 px-1.5 text-[8px] font-bold uppercase tracking-wider border-destructive text-destructive hover:bg-destructive/10 rounded-none shrink-0"
                                    title="Split post into a new tweet"
                                  >
                                    Split
                                  </Button>
                                )}
                                <span className={`text-[10px] font-bold font-mono ${adjustedLength > threadLimit ? 'text-destructive font-black' : 'text-muted-foreground'}`}>
              ...
              <div className="flex items-center gap-4 shrink-0">
                 {hasLimitExceeded && (
                  <Button
                    ...
                    className="h-7 px-2 text-[9px] uppercase font-bold tracking-widest bg-yellow-200 hover:bg-yellow-300 text-black border-2 border-black shadow-[2px_2px_0px_rgba(0,0,0,1)] hover:shadow-[1px_1px_0px_rgba(0,0,0,1)] hover:translate-x-[1px] hover:translate-y-[1px] rounded-none shrink-0 flex items-center gap-1.5 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                ...
                <div className={cn(
                  ...
                  isActiveTabOverLimit ? "text-destructive font-black bg-destructive/10 px-1.5 py-0.5 border border-destructive/20" : "text-muted-foreground"
                )}>
        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
            ...
            <CardContent className="p-6 bg-muted/5 min-h-[400px] flex flex-col items-center justify-start border-b border-border overflow-y-auto max-h-[600px] no-scrollbar">
              {isSimulating ? (
                <div className="flex flex-col items-center justify-center h-full gap-3 mt-20">
                  ...
                  <span className="text-[9px] font-bold uppercase tracking-widest text-muted-foreground font-mono">Simulating Previews...</span>
                </div>
          ...
          <Card className="rounded-none border-border shadow-none bg-card">
            <div className="border-b border-border p-4">
              <div className="text-xs font-bold uppercase tracking-widest text-foreground">Post Format</div>
            </div>
                  ...
                  {[
                    ...
                    return (
                      <Button
                        ...
                        className={cn(
                          "rounded-none font-bold uppercase tracking-widest text-[10px] h-10 border-border transition-all active:scale-[0.98]",
            ...
            <CardContent className={cn("p-4 space-y-4 transition-all duration-300", !isScheduling && "opacity-40 grayscale pointer-events-none")}>
              ...
              <div className="grid grid-cols-2 gap-2 border-b border-border/40 pb-3">
                <button
                  ...
                  className={cn(
                    "py-1.5 px-3 border font-mono font-bold uppercase tracking-widest text-[9px] text-center transition-all",
                    scheduleMode === "queue"
              ...
              {scheduleMode === "queue" ? (
                <div className="bg-muted/50 border border-border/85 p-3.5 space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest text-foreground">Next Queue Slot</span>
                  </div>
                  {nextQueueSlot ? (
              ...
              {!isPreviewVideo ? (
                ...
                <div className="p-4 flex flex-col gap-6">
                  ...
                  <div className="flex justify-end gap-3">
                    ...
                    <Button 
                      className="rounded-none h-10 px-10 bg-primary text-primary-foreground hover:bg-primary/90 uppercase font-black text-[10px] tracking-[0.15em]" 
                      onClick={() => {
        ...
        <DialogContent className="max-w-[450px] p-6 border-border border-2 bg-card rounded-none shadow-2xl overflow-hidden flex flex-col gap-4 focus:outline-none">
          ...
          {(() => {
            ...
            return (
              <div className="flex items-center gap-3 p-3 border border-border bg-muted/20">
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-xs font-black uppercase tracking-wider truncate">{acc.name}</div>
          ...
          <div className="space-y-4 py-2">
            <div className="space-y-1.5 text-left">
              <div className="flex justify-between items-center">
                <Label htmlFor="modal-youtube-title" className="text-xs font-bold uppercase tracking-wider text-muted-foreground">
            ...
            <div className="space-y-1.5 text-left">
              <Label htmlFor="modal-youtube-category" className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">
                Category
              </Label>
              <Select
                value={modalCategory}
            ...
            <div className="space-y-1.5 text-left">
              <div className="flex justify-between items-center">
                <Label htmlFor="modal-youtube-tags" className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">
                  Tags
                </Label>
          ...
          <div className="flex justify-end gap-3 mt-2">
            <Button
              ...
              className="rounded-none border-border h-10 px-6 uppercase font-bold text-[9px] tracking-widest"
            >
              Cancel
            </Button>
            <Button
      ...
      <Dialog open={isPinterestModalOpen} onOpenChange={(open) => { setIsPinterestModalOpen(open); if (!open) { setPinterestBoards([]); setIsFetchingBoards(false); } }}>
        <DialogContent className="max-w-[450px] p-6 border-border border-2 bg-card rounded-none shadow-2xl overflow-hidden flex flex-col gap-4 focus:outline-none">
          ...
          <div className="space-y-4 py-2">
            {/* Pin Title */}
            <div className="space-y-1.5 text-left">
              <Label htmlFor="modal-pinterest-title" className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">
                Pin Title
              </Label>
              <Input
                ...
                <div className="flex items-center gap-2">
                  {pinterestBoards.length === 0 && (
                    <button
                      ...
                      className="text-[9px] text-primary uppercase tracking-wider font-bold hover:opacity-70 transition-opacity disabled:opacity-40 flex items-center gap-1"
                    >
                      {isFetchingBoards ? (
                  ...
                  {pinterestBoards.length > 0 && (
                    <button
                      ...
                      className="text-[9px] text-muted-foreground uppercase tracking-wider font-bold hover:opacity-70 transition-opacity"
                    >
                      Clear ×
                    </button>
                  )}
                  <a
                    ...
                    className="text-[9px] text-primary underline underline-offset-2 uppercase tracking-wider font-bold hover:opacity-70 transition-opacity"
                  >
                    Open Pinterest ↗
                  </a>
                </div>
              ...
              {isFetchingBoards ? (
                ...
                <div className="space-y-2">
                  <div className="flex gap-2">
                    ...
                    {(modalPinterestBoardId.startsWith('http') || modalPinterestBoardId.includes('pinterest.com') || modalPinterestBoardId.includes('pin.it')) && (
                      <Button
                        ...
                        className="rounded-none h-9 px-3 text-[10px] uppercase font-bold tracking-wider shrink-0 bg-primary/10 hover:bg-primary/20 text-primary border border-primary/20 disabled:opacity-50"
                      >
                  ...
                  <div className="bg-muted/40 border border-border/50 p-2.5 space-y-1.5 text-[9px] text-muted-foreground">
                    <p className="font-bold uppercase tracking-wider text-primary flex items-center gap-1">
                    ...
                    <div className="border-t border-border/40 pt-1.5 space-y-1">
                      <p className="font-semibold uppercase text-foreground/70">Or Find Manually:</p>
            ...
            {/* Destination Link */}
            <div className="space-y-1.5 text-left">
              <Label htmlFor="modal-pinterest-link" className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">
                Destination Link
              </Label>
              <Input
        ...
        <DialogContent className="max-w-[400px] p-6 border-border border-2 bg-card rounded-none shadow-2xl overflow-hidden flex flex-col gap-4 focus:outline-none">
                ...
                <div key={idx} className="flex items-center justify-between p-3 border border-destructive/20 bg-destructive/5 rounded-none">
                  <div className="flex items-center gap-2 min-w-0">
                    <div className="w-8 h-8 border border-border overflow-hidden bg-background shrink-0">
                      {item.icon ? (
                        <div className="w-full h-full bg-muted flex items-center justify-center text-xs text-foreground font-black">
                    ...
                    <div className="min-w-0 text-left">
                      <div className="text-xs font-black uppercase tracking-wider truncate">{item.name}</div>
                  ...
                  <div className="text-right shrink-0">
                    ...
                    <div className="text-[8px] font-black uppercase tracking-widest text-destructive/70 mt-0.5">
          ...
          <div className="flex flex-col gap-2 mt-2">
            ...
            <Button
              ...
              className="w-full rounded-none h-10 bg-primary text-primary-foreground hover:bg-primary/90 uppercase font-black text-[10px] tracking-[0.15em]"
            >
              Close & Edit Post
            </Button>
          </div>
        ...
        <DialogContent className="max-w-[460px] p-6 border-border border-2 bg-card rounded-none shadow-2xl focus:outline-none">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="text-sm font-black uppercase tracking-widest text-foreground">YouTube Doesn't Support Images</h3>
            ...
            <div className="border border-border bg-muted/20 p-4 space-y-3">
              <p className="text-[10px] font-black uppercase tracking-widest text-foreground">What you can do</p>
            ...
            <div className="flex gap-3">
              <Button
                ...
                className="flex-1 rounded-none h-10 border-2 border-border font-bold text-xs uppercase tracking-wider"
              >
                Cancel
              </Button>
              <Button
                ...
                className="flex-1 rounded-none h-10 bg-red-600 hover:bg-red-700 text-white font-black text-xs uppercase tracking-wider"
              >
