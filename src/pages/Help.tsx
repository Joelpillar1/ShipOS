...
const Help = () => {
 ...
 <div className="mb-10">
 <h1 className="text-3xl font-bold tracking-tighter text-foreground mb-2">Help Center</h1>
 ...
 <TabsTrigger value="faq" className="rounded-none font-bold text-[10px] tracking-widest">FAQ</TabsTrigger>
 <TabsTrigger value="feedback" className="rounded-none font-bold text-[10px] tracking-widest">Feedback</TabsTrigger>
 </TabsList>
 ...
 <Label htmlFor="feedback-type" className="text-[10px] font-bold tracking-wider text-muted-foreground">Feedback Type</Label>
 <Select 
 ...
 <SelectItem value="bug" className="text-xs font-semibold">Bug Report</SelectItem>
 <SelectItem value="feature" className="text-xs font-semibold">Feature Request</SelectItem>
 <SelectItem value="improvement" className="text-xs font-semibold">UI/UX Improvement</SelectItem>
 <SelectItem value="review" className="text-xs font-semibold">Review</SelectItem>
 ...
 <Label className="text-[10px] font-bold tracking-wider text-muted-foreground block">Satisfaction Rating</Label>
...
"w-12 h-10 border font-bold text-xs transition-all rounded-none flex items-center justify-center shadow-none",
 ...
 <div className="space-y-1.5 text-left">
 <Label htmlFor="feedback-comment" className="text-[10px] font-bold tracking-wider text-muted-foreground">Comments & Details</Label>
 <Textarea
 id="feedback-comment"
 ...
 <Button type="submit" className="w-full rounded-none bg-primary text-primary-foreground hover:bg-primary/95 font-bold tracking-widest text-[10px] h-11 px-5 shadow-none">
