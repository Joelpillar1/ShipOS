...
const ResetPassword = () => {
 ...
 className="bg-primary hover:bg-primary/90 text-primary-foreground rounded-none h-10 text-[10px] font-bold tracking-widest px-8 shadow-none"
 >
 Request a new link
 </Button>
 </div>
 ...
 <Button
 onClick={() => navigate('/login')}
 className="w-full bg-primary hover:bg-primary/90 text-primary-foreground h-10 rounded-none text-[10px] font-bold tracking-widest shadow-none mt-2"
 >
 Sign in now
 </Button>
 </div>
 ...
 className="w-full bg-primary hover:bg-primary/90 text-primary-foreground h-10 rounded-none text-[10px] font-bold tracking-widest shadow-none"
 >
