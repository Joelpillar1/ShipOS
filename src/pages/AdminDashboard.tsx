...
function CustomTooltip({ active, payload, label }: any) {
 ...
 <p className="font-bold text-foreground mb-2 tracking-wider text-[9px]">{label}</p>
 {payload.map((p: any) => (
...
export default function AdminDashboard() {
 ...
 <div className="flex items-center gap-3">
 {isMock && (
 <div className="flex items-center gap-1.5 border border-primary/20 bg-primary/5 px-3 py-1 rounded-none text-primary font-bold text-[9px] tracking-wider">
 ...
 className={cn('h-8 gap-1.5 text-[10px] font-bold tracking-wider rounded-none bg-transparent border-border text-muted-foreground hover:bg-muted/50 hover:text-foreground', liveMode && 'bg-primary text-primary-foreground hover:bg-primary/90 border-primary/50')}
 ...
 {supabase && (
 <Button size="sm" variant="outline" className="h-8 gap-1.5 text-[10px] font-bold tracking-wider rounded-none bg-transparent border-border text-muted-foreground hover:bg-muted/50 hover:text-foreground"
 ...
 <p className="text-[10px] tracking-[0.25em] text-muted-foreground">Plan Distribution</p>
 ...
 <div>
 <h3 className="text-xs font-mono font-bold text-foreground tracking-wider">User Registration Matrix</h3>
 ...
 <div className="flex items-center justify-between mb-6">
 <div>
 <h3 className="text-xs font-mono font-bold text-foreground tracking-wider">Social Integrations</h3>
 ...
 <div>
 <h3 className="text-xs font-mono font-bold text-foreground tracking-wider">Scheduler Post Engine Output</h3>
 ...
 <div>
 <h3 className="text-sm font-bold text-foreground tracking-wider">Customer Directory</h3>
 ...
 <DropdownMenuLabel className="text-[9px] tracking-wider text-muted-foreground">PLAN LAYER</DropdownMenuLabel>
 ...
 <DropdownMenuContent className="rounded-none bg-card border-border text-foreground text-xs">
 <DropdownMenuLabel className="text-[9px] tracking-wider text-muted-foreground">PLAN STATE</DropdownMenuLabel>
 <DropdownMenuSeparator className="bg-border" />
 ...
 <thead>
 <tr className="border-b border-border text-[9px] text-muted-foreground tracking-wider select-none bg-muted/10">
 ...
 <span className={cn('text-[9px] font-bold border px-2 py-0.5 rounded-none ', planColor(u.plan))}>
 {u.plan}
 </span>
 </td>
 <td className="py-4 px-4">
 <span className={cn('text-[9px] font-bold border px-2 py-0.5 rounded-none ', statusColor(u.planStatus))}>
 {u.planStatus}
 </span>
 </td>
 ...
 <DropdownMenuLabel className="text-[9px] tracking-wider text-muted-foreground">ADMIN CONTROLS</DropdownMenuLabel>
 <DropdownMenuSeparator className="bg-border" />
 <DropdownMenuSub>
 ...
 <div className="flex items-center gap-2">
 <span className="text-[9px] font-bold tracking-widest text-muted-foreground/70 mr-2">SIMULATION PIPELINE:</span>
 <Button size="sm" variant="outline" onClick={() => simulate('signup')}
 className="h-8 rounded-none border-emerald-500/20 bg-emerald-500/5 hover:bg-emerald-500/15 text-emerald-600 dark:text-emerald-400 text-[10px] bg-transparent font-sans">
 <UserPlus className="w-3.5 h-3.5 mr-1" /> Mock Signup
 </Button>
 <Button size="sm" variant="outline" onClick={() => simulate('upgrade')}
 className="h-8 rounded-none border-violet-500/20 bg-violet-500/5 hover:bg-violet-500/15 text-violet-600 dark:text-violet-400 text-[10px] bg-transparent font-sans">
 <ArrowUpCircle className="w-3.5 h-3.5 mr-1" /> Mock Upgrade
 </Button>
 <Button size="sm" variant="outline" onClick={() => simulate('post')}
 className="h-8 rounded-none border-primary/20 bg-primary/5 hover:bg-primary/15 text-primary text-[10px] bg-transparent font-sans">
 ...
 <div className="flex-1 min-w-0">
 <div className="flex items-center gap-2">
 <span className="font-bold text-foreground tracking-wider text-[10px] font-sans">{entry.event}</span>
 ...
 <div>
 <h4 className="text-xs font-bold text-foreground tracking-wider">{h.name}</h4>
 <p className="text-[10px] text-muted-foreground mt-0.5">{h.desc}</p>
 <div className="mt-4 flex items-center gap-2">
 <span className={cn("text-xs font-bold", h.color)}>{h.status}</span>
 ...
 <div>
 <h3 className="text-xs font-bold text-foreground tracking-wider">Node Resource Allocation</h3>
 ...
 <div className="border border-border bg-card rounded-none p-6 space-y-6">
 <div>
 <h3 className="text-xs font-bold text-foreground tracking-wider">Subservice Handshakes</h3>
 ...
 <span>{s.latency}</span>
 <span className={cn("font-bold text-[9px] px-1.5 py-0.5 rounded-none border", s.status === 'OPERATIONAL' ? 'border-emerald-500/20 bg-emerald-500/5 text-emerald-500 dark:text-emerald-400' : 'border-amber-500/20 bg-amber-500/5 text-amber-500 dark:text-amber-400')}>
 {s.status}
 </span>
 </div>
 </div>
