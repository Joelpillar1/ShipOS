    ...
    <div className="min-h-screen relative bg-background flex items-center justify-center px-4 overflow-hidden text-foreground">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-[9px] font-bold text-muted-foreground uppercase tracking-[0.25em] mt-2">
          ...
          <CardContent className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Button 
                ...
                className="w-full bg-primary hover:bg-primary/90 text-primary-foreground h-11 rounded-none text-[10px] font-bold tracking-widest uppercase shadow-none border border-primary/20"
              >
